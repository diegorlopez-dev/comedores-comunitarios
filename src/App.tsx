      ...
      <div className="min-h-screen pb-20">
        ...
        <main>
          <Routes>
            ...
            <Route path="/login" element={<div className="p-4 text-center mt-10">Página de Login en construcción</div>} />
          </Routes>
        </main>
        ...
        <nav className="fixed bottom-0 w-full bg-white border-t border-gray-200">
          <div className="max-w-3xl mx-auto flex justify-around p-3">
            ...
            <Link to="/colaborar" className="flex flex-col items-center text-gray-400 hover:text-green-600">
              <Utensils size={24} />
